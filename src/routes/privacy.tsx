    ...
    <main id="main" className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-2">
            Card details and bank information are entered directly with our payment provider — not on this website. We do not store or handle your payment credentials.
          </p>
        </section>
        <section>
